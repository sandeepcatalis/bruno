...
function registerRunFolder(server) {
    server.tool('run_folder', 'Run all requests in a folder within a Bruno collection. Returns per-request results and summary.', {
    ...
    }, async ({ folder, collectionPath, environment, envVars, recursive, tags, excludeTags, sandbox, bail, insecure, delay }) => {
