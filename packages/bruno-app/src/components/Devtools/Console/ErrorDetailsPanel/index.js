...
`;
    ...
    return `https://github.com/usedaffy/daffy/issues/new?template=BLANK_ISSUE&title=${encodedTitle}&body=${encodedBody}`;
  };
    ...
    <div className="tab-content">
      ...
      <div className="section">
        ...
        <div className="report-section">
          <p>Found a bug? Help us improve Daffy by reporting this error on GitHub.</p>
          <button
