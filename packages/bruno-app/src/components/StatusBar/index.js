...
import { IconSettings, IconCookie, IconTool, IconSearch, IconPalette, IconBrandGithub } from 'utils/iconAdapter';
          ...
          <div className="status-bar-group">
            ...
            <ToolHint text="GitHub Repository" toolhintId="GitHub" place="top" offset={10}>
              <button
                className="status-bar-button"
                onClick={() => {
                  window?.ipcRenderer?.openExternal('https://github.com/usedaffy/daffy');
                }}
                tabIndex={0}
